...
- **Geschiedenis** opens a linked dashboard over ~1400 logged questions from the past 60 days. Click any complaint, age group or outcome and every other panel, plus the klacht × leeftijd matrix, narrows to that group; "Opvallend aan deze selectie" then names what stands out. Click acne and switch the age panel to Aandeel: it is 15% of what the 18-34 group asks but 44% of what the 12-17 group asks. Ten of the questions are from this session and reopen when clicked. No personal data: buckets, categories and outcomes only.
